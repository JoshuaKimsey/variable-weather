...
function showFrame(index) {
    ...
    // console.log(`Showing radar frame ${index}`);
    
    try {
        // Format for tile URL according to RainViewer docs:
        // https://tilecache.rainviewer.com/v2/radar/{time}/512/{z}/{x}/{y}/{color}/1_1.png
        ...
        // console.log('Creating radar tile layer with URL pattern:', tileUrl);
        
        // Create a tile layer (this will align correctly with the map)
        currentOverlay = L.tileLayer(tileUrl, {
        ...
        console.error('Error showing radar frame:', error);
    }
